...
(function () {
    ...
    angular
        .module('emitters')
        .factory('emittersFactory', emittersFactory);

        emittersFactory.$inject = ['$totvsresource'];

    function emittersFactory($totvsresource) {

        var url = 'http://localhost:3000/emitentesEntrega/:id',
            factory;
