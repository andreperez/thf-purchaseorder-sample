...
(function () {
    ...
    angular
        .module('emitters')
        .factory('zoomEmittersFactory', zoomEmittersFactory);

    zoomEmittersFactory.$inject = ['emittersFactory', 'indexesFactory'];

    function zoomEmittersFactory(emittersFactory, indexesFactory) {
        ...
        function countRecords() {
            ...
            parameters._start = 0;
            parameters._limit = 1;
            parameters.tabela = 'emitentesEntrega';
        ...
        var zoom = {
            ...
            applyFilter: function (params) {
                ...
                return emittersFactory.findRecords(parameters, function (result) {
                    if (result) {
                        countRecords();
            ...
            getObjectFromValue: function (parameter) {
                ...
                return emittersFactory.getRecord(parameter, undefined);
            }
        };
