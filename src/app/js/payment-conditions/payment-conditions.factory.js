...
(function () {
    ...
    angular
        ...
        .factory('paymentConditionsFactory', paymentConditionsFactory);

        paymentConditionsFactory.$inject = ['$totvsresource'];

    function paymentConditionsFactory($totvsresource) {

        var url = 'http://localhost:3000/condicaoPagamento/:id',
            factory;
