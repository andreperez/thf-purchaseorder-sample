...
(function () {
    ...
    angular
        .module('transporters')
        .factory('transportersFactory', transportersFactory);

        transportersFactory.$inject = ['$totvsresource'];

    function transportersFactory($totvsresource) {

        var url = 'http://localhost:3000/transportadores/:id',
            factory;
