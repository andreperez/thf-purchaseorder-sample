...
(function () {
    ...
    angular
        ...
        .factory('establishmentsFactory', establishmentsFactory);

        establishmentsFactory.$inject = ['$totvsresource'];

    function establishmentsFactory($totvsresource) {

        var url = 'http://localhost:3000/estabelecimentos/:id',
            factory;
